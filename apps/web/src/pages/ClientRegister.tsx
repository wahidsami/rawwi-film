...
export function ClientRegister() {
  ...
  const registrationEmail = (beneficiaryType === 'company' ? form.email : form.contactEmail).trim().toLowerCase();
