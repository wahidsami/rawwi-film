    ...
    <div className="client-portal-theme client-portal-shell min-h-screen text-text-main">
      <div className="mx-auto flex min-h-screen max-w-[1600px] flex-col px-3 py-3 md:px-5 md:py-5">
        ...
        <div className="grid flex-1 gap-4 lg:grid-cols-[300px_minmax(0,1fr)]">
          <aside className="client-portal-panel hidden rounded-[calc(var(--radius)+0.75rem)] border border-border/70 p-4 shadow-[0_20px_60px_rgba(31,23,36,0.06)] lg:block">
              ...
              {navItems.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      'client-portal-sidebar-link flex w-full items-start gap-3 rounded-[calc(var(--radius)+0.45rem)] px-4 py-3 text-start transition',
                      active
