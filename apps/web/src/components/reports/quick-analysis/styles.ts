...
export const quickAnalysisStyles = StyleSheet.create({
  page: { padding: 26, fontSize: 10, color: "#111827" },
  pageAr: { fontFamily: "QuickAnalysisCairo" },
  rtl: { textAlign: "right" },
