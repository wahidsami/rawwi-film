...
const translations = {
  ar: {
    ...
    accessDeniedSection: 'ليس لديك صلاحية الوصول إلى هذا القسم.',
    accessDeniedPermission: 'ليس لديك الصلاحيات المطلوبة لعرض هذه الصفحة.',
    backToHome: 'العودة للرئيسية',
    superAdmin: 'مدير النظام',
    superadmin: 'مدير النظام',
    admin: 'مشرف',
    regulator: 'مراقب',
    addNewClient: 'إضافة مستفيد جديد',
    totalClients: 'إجمالي المستفيدين',
    ...
    clientDetails: 'تفاصيل المستفيد',
    searchClients: 'ابحث عن اسم الشركة (عربي / انجليزي)',
    editClient: 'تعديل بيانات المستفيد',
    ...
    accessControlSubtitle: 'إدارة أدوار المستخدمين والصلاحيات',
    companyCreated: 'تم إنشاء الشركة بنجاح',
    errorGeneric: 'خطأ',
    companyUpdated: 'تم تحديث الشركة بنجاح',
    clientDeleted: 'تم حذف المستفيد',
    failedToDeleteClient: 'فشل حذف المستفيد',
    scriptCreated: 'تم إنشاء النص',
    errorCreatingScript: 'خطأ في إنشاء النص',
    taskAssignedSuccess: 'تم تعيين المهمة بنجاح',
    violationMarkedSuccess: 'تم تسجيل المخالفة بنجاح',
    statusUpdated: 'تم تحديث الحالة',
    overrideSaved: 'تم حفظ التجاوز',
    overrideReverted: 'تم إلغاء التجاوز',
    termSavedSuccess: 'تم حفظ المصطلح بنجاح',
    termUpdatedSuccess: 'تم تحديث المصطلح بنجاح',
    termDeletedSuccess: 'تم حذف المصطلح بنجاح',
    ...
    findingSourceGlossary: 'قاموس المصطلحات',
    ...
    findingsByType: 'توزيع الملاحظات حسب النوع',
    open: 'فتح',
    openHtml: 'فتح HTML',
  ...
  en: {
    ...
    overview: 'Overview',
    glossary: 'Glossary',
    clients: 'Beneficiaries (Companies)',
    ...
    accessDeniedSection: 'You do not have access to this section.',
    accessDeniedPermission: 'You do not have the required permissions to view this page.',
    backToHome: 'Back to Home',
    superAdmin: 'Super Admin',
    superadmin: 'Super Admin',
    admin: 'Admin',
    regulator: 'Regulator',
    addNewClient: 'Add New Beneficiary',
    totalClients: 'Total Beneficiaries',
    ...
    clientDetails: 'Beneficiary Details',
    searchClients: 'Search company name (Arabic / English)',
    editClient: 'Edit Beneficiary Data',
    editData: 'Edit Data',
    clientUpdated: 'Beneficiary updated successfully',
    ...
    accessControlSubtitle: 'Manage user roles and permissions',
    companyCreated: 'Company created successfully',
    errorGeneric: 'Error',
    companyUpdated: 'Company updated successfully',
    clientDeleted: 'Beneficiary deleted',
    failedToDeleteClient: 'Failed to delete beneficiary',
    scriptCreated: 'Script created',
    errorCreatingScript: 'Error creating script',
    taskAssignedSuccess: 'Task assigned successfully',
    violationMarkedSuccess: 'Violation marked successfully',
    statusUpdated: 'Status updated',
    overrideSaved: 'Override saved',
    overrideReverted: 'Override reverted',
    termSavedSuccess: 'Term saved successfully',
    termUpdatedSuccess: 'Term updated successfully',
    termDeletedSuccess: 'Term deleted successfully',
    ...
    findingSourceGlossary: 'Glossary',
    ...
    addClientAction: 'Add New Beneficiary',
