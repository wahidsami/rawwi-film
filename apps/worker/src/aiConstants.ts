...
4) final_ruling يجب أن تكون واحدة فقط من:
   ...
   - needs_review
   - context_ok
5) rationale_ar إلزامية ولا يُقبل تركه فارغاً أو حذفه: اشرح فيها بشكل واضح أين يظهر المقتطف في النص (حوار، حلم، وصف، مشهد عنف)، ماذا يعني في السياق السردي، ولماذا اعتُبرت مخالفة (أو needs_review أو context_ok) وربطها بالمادة الأساسية. الهدف: أن يظهر التعليل أن المدقق يفهم مكان الجملة ومعناها في القصة وليس مجرد اللفظ.
