...
4) final_ruling يجب أن تكون واحدة فقط من:
   ...
   - needs_review
   - context_ok
5) rationale_ar إلزامية لكل assessment: اشرح فيها بشكل واضح:
   - أين يظهر المقتطف في النص (حوار شخصية، حلم، وصف سردي، مشهد عنف، إلخ)،
   - ماذا يعني في السياق السردي (هل هو تأييد للمخالفة أم مجرد ذكر ضمن سياق درامي أو أوهام مريض)،
   - ولماذا اعتُبرت مخالفة (أو needs_review أو context_ok) وربطها بالمادة الأساسية.
   الهدف: أن يظهر التعليل أن المدقق يفهم مكان الجملة ومعناها في القصة وليس مجرد اللفظ.
  ...
  "assessments": [
    {
      ...
      "rationale_ar": "جملة أو جملتان بالعربية تشرح أين في النص، ماذا يعني في السياق، ولماذا الحكم (مخالفة/مراجعة/مطابق).",
