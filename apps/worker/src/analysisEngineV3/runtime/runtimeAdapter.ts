...
function defaultOutputSchema(): V3PromptOutputSchema {
  return {
    ...
    notes: [
      ...
      "The reasoned decision must be evidence-first, quote-grounded, single-article, and non-hallucinatory.",
      ...
      "If evidence is insufficient, return NO VIOLATION instead of guessing.",
      "Choose at most one applicable article in the reasoned decision.",
