...
function buildGptReviewerAssistant(
  ...
  return Object.freeze({
    ...
    knowledge: Object.freeze({
      ...
      exhaustive_review: "Your task is to find all policy violations. Do not stop after finding one exception. Analyze every threatening, abusive, violent, sexual, political, religious, criminal, or profane statement independently.",
