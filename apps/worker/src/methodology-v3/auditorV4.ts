...
const CATEGORY_RULES: Record<AuditorV4Category, CategoryRule> = {
  ...
  bullying: {
    ...
    score: (evidence) => {
      ...
      if (!containsAnyNormalized(evidence, ["غبي", "أحمق", "فاشل", "ما تسوى", "لا أحد يبيك", "مقرف", "سخيف", "حقير", "وضيع", "جبان", "تافه", "عديم التربية", "اسكت", "اسكتي", "كذاب", "كذابين", "كاذب", "كاذبين", "حرامي", "حرامية", "نصاب", "نصابين", "نصابة", "محتال", "محتالين", "كلب", "حمار", "أهبل", "اهبل"])) return 0;
      return 2;
    },
  },
  profanity: {
    ...
    score: (evidence) => {
      if (!containsAnyNormalized(evidence, ["يلعن", "العن", "لعن", "لعنة", "لعنك", "تبا", "تبًا", "تباً", "خرا", "وسخ", "قذر", "حقير", "وضيع", "نذل", "خسيس", "لئيم", "جبان", "ساقط", "يا حمار", "يا كلب", "يا خرا", "العن أمك", "العن امك", "العن والديك"])) return 0;
      if (containsAnyNormalized(evidence, ["الدين", "الإسلام", "الصلاة", "الأذان", "القرآن", "السنة"]) && !containsAnyNormalized(evidence, ["يلعن", "العن", "لعن", "لعنة", "لعنك", "تبًا", "تبا"])) return 0;
      return 3;
    },
  },
  other: {
...
function categoryHasSignature(category: AuditorV4Category, evidence: string): boolean {
  ...
  switch (category) {
    ...
    case "bullying":
      return containsAnyNormalized(text, ["غبي", "أحمق", "فاشل", "ما تسوى", "لا أحد يبيك", "مقرف", "سخيف", "حقير", "وضيع", "جبان", "تافه", "عديم التربية", "كذاب", "كذابين", "كاذب", "كاذبين", "حرامي", "حرامية", "نصاب", "نصابين", "نصابة", "محتال", "محتالين", "كلب", "حمار", "أهبل", "اهبل", "يا فاشل", "يا غبي", "يا أحمق", "يا كذاب", "يا حرامي", "يا نصاب", "كلهم كذابين", "كلهم حرامية"]);
    case "profanity":
      return containsAnyNormalized(text, ["يلعن", "العن", "لعن", "لعنة", "لعنك", "تبا", "تبًا", "تباً", "خرا", "وسخ", "قذر", "ساقط", "نذل", "خسيس", "لئيم", "يا حمار", "يا كلب", "يا خرا", "العن أمك", "العن امك", "العن والديك"]);
    case "other":
